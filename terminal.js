...
var Terminal = Terminal || function(cmdLineContainer, outputContainer) {
    ...
    if (e.keyCode == 9) { // tab
      ...
      switch (cmd) {
        ...
        case 'help':
          ...
          break;
        case 'education':
          var result = "<h3>Education</h3><p>Bachelor's degree in Computer science at Faculté polydisciplinaire de Safi, completed ✅, So what's next?.</p>";
        ...
        var result = "<h3>Interests</h3><p>Balling, Travelling, Coding, Problem Solving..</p>";
          ...
          break;
        case 'blog':
          var result = "<h3>Keeping it quiet for the moment hhhhhh </h3>";
          output(result);
          break;
        case 'contact':
          var result = "<h3>Contact</h3><h4>Email: mohammedalicherraoui@gmail.com<br>LinkedIn: Mohammed-ali CHERRAOUI<br>Portfolio: mo24ali.github.io</h4> ";
          output(result);
          break;
        case 'whoami':
          var result = "<h1>Mohammed-ali CHERRAOUI</h1><p>Software developer with a passion for computer science. Fluent in Arabic, English, and French. Experienced freelancer in programming, web design, and copywriting. Eager to apply technical knowledge and problem-solving skills to real-world situations. Confident in delivering high-quality results and always looking for new challenges and opportunities to expand the skill set.</p>";
          output(result);
          break;
          case 'love':
            output("<h3>404...</h3>");
  ...
  return {
    init: function() {
      output('<h1>Mohammed-ali CHERRAOUI</h1><h3>Software developer<br><p>Enter "help" for more information.</p>');
    },
    output: output
  }
};
